...
export default function AuthScreen() {
  ...
  const GoogleSignin = !isExpoGo ? require('@react-native-google-signin/google-signin').GoogleSignin : null;
  const statusCodes = !isExpoGo ? require('@react-native-google-signin/google-signin').statusCodes : {};
